...
void BasicStmtAST::Dump2KooPa() const
{
    ...
    else if (type == CONTINUE)
    {
        ...
        std::cout << "  "
                  << "jump " << last_while_entry << std::endl;
        // dummy here
...
void WhileStmtAST::Dump2KooPa() const
{
    if (type == WHILE)
    {
        ...
        std::cout << "  "
                  << "jump " << ident_while_entry << std::endl;
        std::cout << ident_while_entry << ":" << std::endl;
        std::string ret_var = while_exp->ExpDump2KooPa();
        std::cout << "  "
                  << "br " << ret_var << ", " << ident_while_body << ", " << ident_while_end << std::endl;
...
std::string LAndExpAST::ExpDump2KooPa() const
{
    ...
    else if (type == LAND)
    {
        ...
        std::cout << "  "
                  << "store 0, " << res_var << std::endl;
        std::cout << "  "
                  << "br " << land_var << ", " << then_ident << ", " << else_ident << std::endl;
        ...
        std::cout << "  "
                  << "store " << tmp_res_var << ", " << res_var << std::endl;
        std::cout << "  "
                  << "jump " << end_ident << std::endl;
...
std::string LOrExpAST::ExpDump2KooPa() const
{
    ...
    else if (type == LOR)
    {
        ...
        std::cout << "  " << res_var << " = alloc i32" << std::endl;
        std::cout << "  "
                  << "store 1, " << res_var << std::endl;
        std::cout << "  "
                  << "br " << lor_var << ", " << then_ident << ", " << else_ident << std::endl;
